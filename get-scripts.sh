...
#  Copies all install scripts and configs to /mnt/install/
...
if [[ "$SCRIPT_BASE" == /* ]]; then
    ...
    cp "$SCRIPT_BASE"/install/part*.sh               /mnt/install/
    ...
    # Scripts
    curl -fsSL "$SCRIPT_BASE/install/part2-chroot.sh"       -o /mnt/install/part2-chroot.sh
    curl -fsSL "$SCRIPT_BASE/install/part3-secureboot.sh"   -o /mnt/install/part3-secureboot.sh
    curl -fsSL "$SCRIPT_BASE/install/part4-post-reboot.sh"  -o /mnt/install/part4-post-reboot.sh
    curl -fsSL "$SCRIPT_BASE/install/part5-user-setup.sh"   -o /mnt/install/part5-user-setup.sh
    curl -fsSL "$SCRIPT_BASE/install/part6-hyprland.sh"     -o /mnt/install/part6-hyprland.sh
...
echo "[*] All scripts and configs copied successfully."