...
rd.luks.name=$LUKS_UUID=cryptroot rd.luks.options=tpm2-device=auto,tpm2-pcrs=0+7+11 root=/dev/mapper/cryptroot rootfstype=$ROOT_FS rw lsm=landlock,lockdown,yama,integrity,apparmor,bpf quiet splash
EOF
